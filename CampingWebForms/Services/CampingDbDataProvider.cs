...
namespace CampingWebForms.Services
{
    ...
    //public class CampingDbDataProvider : IDataProvider
    //{
    //    private readonly CampingDBEntities dbContext;
    //    public CampingDbDataProvider(CampingDBEntities dbContext)
    //    {
    //        this.dbContext = dbContext;
    //    }
    ...
    //        CampingWebForms.CampingPlace dbCampingPlace = convertFromPlace(newCampingPlace);
    //        this.dbContext.CampingPlaces.Add(dbCampingPlace);
    //        dbContext.SaveChanges();
    //    }
    ...
    //    private ISightseeing ConvertToSightseeeing(CampingWebForms.Sightseeing s)
    //    {
    //        ISightseeing sightseeing = new Sightseeing();
    //        sightseeing.Name = s.Name;
    //        sightseeing.Id = s.Id;
    //        sightseeing.Type = s.SightseeingType.Name;

    //        return sightseeing;
    //    }

    //    private CampingWebForms.CampingPlace convertFromPlace(ICampingPlace p)
    //    {
    //        CampingWebForms.CampingPlace place = new CampingWebForms.CampingPlace();
    //        place.Name = p.Name;
    //        place.Description = p.Description;
    //        place.GoogleMapsUrl = p.GoogleMapsUrl;
    //        place.WaterOnSite = p.HasWater;
    ...
    //    private ICampingPlace ConvertToPlace(CampingWebForms.CampingPlace p)
    //    {
    //        ICampingPlace place = new CampingPlace();
    //        place.Name = p.Name;
    //        place.Id = p.Id;
    ...
    //            sightseeingIds.Add(s.Id);
    //            sightseeingNames.Add(s.Name);
    //            sightseeingTypes.Add(s.SightseeingType.Name);
    //        }
    ...
    //    private ISiteCategory ConvertToCategory(CampingWebForms.SiteCategory c)
    //    {
    //        ISiteCategory category = new SiteCategory();
    //        category.Name = c.Name;
    //        category.Id = c.Id;
